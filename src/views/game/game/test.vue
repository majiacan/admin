<template>
    <div>
      <div class=" menu-filter-top">
       <el-select v-model="listQuery.pos" placeholder="位置" clearable class="filter-item" style="width: 110px">
        <el-option v-for="item in posobj" :key="item.key" :label="item.display_name" :value="item.key" />
      </el-select> 
      <el-select v-model="listQuery.type" placeholder="类型" clearable class="filter-item" style="width: 110px">
             ...
             <div class='all-before1'>
                 <div class='index'>
                     <div class="detail-before detail-all detail-top">
                         <div class='detail-a'>图片:</div>
                        <el-input class='border' type="text" placeholder='indexnameafter'/>
                         <img class='img-all'  :src="indeximgbefore" alt="">
                     </div>
                     <div style='display:flex;flex-wrap:wrap;width:100%'>
                            <div  class="detail-after detail-all detail-margin">
                                <div class='detail-a'>金额:</div>
                                <el-input class='border' type="text" placeholder='indexnameafter'/>
                             </div>
                            <div  class="detail-after detail-all detail-margin">
                                <div class='detail-a'>赏金:</div>
                                <el-input class='border' type="text" placeholder='indexnameafter'/>
                            </div>
                            <div  class="detail-after detail-all detail-margin">
                                <div class='detail-a'>按钮数量:</div>
                                 <el-input class='border' type="text" placeholder='indexnameafter'/>
                            </div>
                            <div  class="detail-after detail-all detail-margin">
                                <div class='detail-a'>可猜次数:</div>
                               <el-input  v-model="listQuery.version" class='border' type="text" placeholder='indexnameafter'/>
                            </div>
                     </div>
    ...
    >
      ...
      <el-table-column label="版本号"  prop="version"   width="100px" align="center">   
      </el-table-column>
       <el-table-column label="编辑"  prop="version"   width="100px" align="center">  
             <template slot-scope="{row}">   
                 <!-- -->
                <el-button type="success" size="mini"   @click='detail(row,event)' >
                  编辑
                </el-button>  
        </template>
      </el-table-column>
      <el-table-column label="操作" align="center" min-width="180" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
           <el-button type="success" size="mini"   @click="changestatus(row,event)" >
           启用
          </el-button>  
          <el-button type="danger" size="mini"   @click="changestatus(row,event)" >
           禁用
          </el-button>
   ...
   <!-- 分页器 -->
    <pagination v-show="total>0" :total="total" :page.sync="listQuery.pn" :limit.sync="listQuery.rn" @pagination="getList" />
       ...
       <el-button  class='dialog-top-button' type="text" @click="dialogVisible = true" >上传</el-button> 
      <el-dialog
